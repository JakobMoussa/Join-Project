...
const overlayContainer = document.querySelector(".overlay");
  overlayContainer.innerHTML = `
    <div class="overlay-wrapper">
      <div class="users-information visible" transit>
        <div class="user-details">
          <div class="user-name-container">
            <div class="avatar-circle" style="background-color: ${id.color};">${id.avatar}</div>
            <div class="user-name">
              <h3>${id.name}</h3>
                <div class="edit-delete-buttons">
                    <button class="edit-field" onclick="editContactOverlay('${id}')">
                        <img src="/assets/icons/edit.svg" alt="Edit icon" class="edit-icon">Edit
                    </button>
                    <button class="edit-field" onclick="deleteUser('users/${id}')">
                        <img src="/assets/icons/delete.svg" alt="Delete icon" class="delete-icon">Delete
                    </button>
                </div>
            </div>
          </div>
